...
version: 1.0.0
description: "When the user wants to create optimized captions and on-screen text for short-form video (TikTok, Reels, Shorts). Also use when writing video hooks using the Triple Word Score optimization system. For video production workflow, see short-form-video. For clip extraction, see youtube-clip-extractor."
---
...
- **Feeds into**: **short-form-video**, **youtube-clip-extractor**
