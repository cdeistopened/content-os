...
version: 1.0.0
description: "When the user wants to create a comprehensive brand identity document for other skills to reference. Also use before running newsletter, podcast, or content skills that need brand context. Outputs brand-identity.md with persona, voice, audience, values, and messaging. For voice analysis from writing samples, see voice-analyzer."
---
...
- **Enhanced by**: **brand-guidelines**, **writing-style**
- **Feeds into**: **brand-guidelines**, **social-content-creation**, **theme-factory**
