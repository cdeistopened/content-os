...
version: 1.0.0
description: "When the user wants to create attention-grabbing hooks and headlines using proven formulas and the 4 U's test. Also use for newsletter subject lines, social media hooks, blog headlines, or any content that needs to stop the scroll. For article titles specifically, see article-titles. For YouTube titles, see youtube-title-creator."
---
