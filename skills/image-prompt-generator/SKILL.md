...
version: 1.0.0
description: "When the user wants to generate AI images using Gemini image generation API. Also use when content needs thumbnails, social post images, blog headers, or creative visuals. For the Nano Banana variant, see nano-banana-image-generator. For video generation, see video-generator."
---
...
### Thumbnail Generation - Example Settings

For thumbnails, use these recommended settings:
...
**Example style: Risograph.** A distinctive aesthetic that works well for thumbnails. Include style instructions in the prompt.
...
- **Enhanced by**: **brand-identity-wizard**, **brand-guidelines**
- **Feeds into**: **nano-banana-image-generator**, **video-generator**, **social-content-creation**
