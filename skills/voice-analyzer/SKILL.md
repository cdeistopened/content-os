...
name: voice-analyzer
version: 1.0.0
description: "When the user wants to analyze writing samples and create a codified voice style guide. Also use when extracting patterns and techniques from example writing to generate a reusable voice skill. For guided wizard workflow, see voice-matching-wizard. For creating voice skills with examples, see voice-wizard."
---
...
- **Upstream**: **anti-ai-writing**
- **Feeds into**: **voice-matching-wizard**, **voice-wizard**, **human-writing**, **ghostwriter**
