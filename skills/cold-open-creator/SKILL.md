...
version: 1.0.0
description: "When the user wants to create a 25-35 second podcast cold open that hooks listeners with a story arc moment. Also use when crafting episode intros or teaser hooks. For full podcast production, see podcast-production. For narrative extraction, see narrative-snippets."
---
...
- **Enhanced by**: **narrative-snippets**, **voice-matching-wizard**
- **Feeds into**: **podcast-production**
