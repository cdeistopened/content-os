...
name: pdf-ocr
version: 1.0.0
description: "When the user wants to convert scanned PDFs or books to editable markdown using Gemini OCR. Also use when processing large PDFs, Latin/scholarly texts, or documents needing structure detection. For general PDF manipulation, see pdf."
---
...
- **Feeds into**: **transcript-polisher**, **multi-source-research**
