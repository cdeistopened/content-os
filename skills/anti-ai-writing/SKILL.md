...
version: 1.0.0
description: "When the user wants to transform AI-assisted drafts into authentic, human-sounding content by detecting and eliminating AI tells. Also use when reviewing AI-generated text or writing content that must not appear AI-assisted. For detailed editing workflows, see human-writing. For voice adaptation, see ghostwriter."
---
...
- **Enhanced by**: **voice-analyzer**, **writing-style**
