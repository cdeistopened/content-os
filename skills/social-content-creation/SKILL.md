...
version: 1.0.0
description: "When the user wants to transform long-form content into platform-optimized social posts using 180+ proven templates. Also use when repurposing newsletters, articles, or podcasts for LinkedIn, X, Facebook, or Instagram. For text-only social posts, see text-content. For X articles specifically, see x-article-converter."
---
