...
name: vellum-prep
version: 1.0.0
description: "When the user wants to convert a markdown manuscript to a Vellum-ready Word document. Also use when preparing OCR output or written manuscripts for Vellum book formatting software."
---
...
- **Enhanced by**: **human-writing**, **doc-coauthoring**
