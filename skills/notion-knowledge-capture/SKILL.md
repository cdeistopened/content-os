...
version: 1.0.0
description: "When the user wants to transform conversations and discussions into structured Notion documentation pages. Also use when capturing insights, decisions, or knowledge from chat context into Notion wikis or databases. For Notion research workflows, see notion-research-documentation."
---
...
- **Enhanced by**: **daily-notes**, **memo**
- **Feeds into**: **notion-research-documentation**
