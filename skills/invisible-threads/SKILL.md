...
version: 1.0.0
description: "When the user wants to discover non-obvious thematic connections across a corpus of essays, articles, or transcripts. Also use when editing an anthology, finding recurring ideas, or weaving quotes across sources. For narrative extraction, see narrative-snippets."
---
