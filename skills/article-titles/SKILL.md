...
name: article-titles
version: 1.0.0
description: "When the user wants to write titles for blog posts, deep dives, or hub articles. Uses 15 proven formulas and 10 Commandments evaluation to generate 10+ options and select the best. For YouTube titles, see youtube-title-creator. For social hooks, see hook-and-headline-writing."
---
...
- **Feeds into**: **how-newsletters**, **x-article-converter**, **youtube-title-creator**
