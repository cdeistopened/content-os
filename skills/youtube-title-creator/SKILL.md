...
version: 1.0.0
description: "When the user wants to generate high-CTR YouTube titles and thumbnails using 119 proven formulas from Creator Hooks. Also use when applying psychological principles to title variations. For article/blog titles, see article-titles. For YouTube scripts, see youtube-scriptwriting."
---
...
- **Upstream**: **article-titles**
- **Enhanced by**: **hook-and-headline-writing**
- **Feeds into**: **youtube-scriptwriting**
