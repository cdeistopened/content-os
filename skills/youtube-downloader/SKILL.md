...
version: 1.0.0
description: "When the user wants to download YouTube video transcripts, captions, or subtitles from a URL. Also use when fetching or transcribing YouTube video content. For extracting clips from videos, see youtube-clip-extractor."
---
...
- **Feeds into**: **transcript-polisher**, **youtube-clip-extractor**, **podcast-blog-post-creator**
