...
version: 1.0.0
description: "When the user wants to render interactive HTML interfaces in chat using the render_ui tool. Also use when displaying UI, creating widgets, showing forms, rendering charts, or building interactive content. For production web artifacts, see web-artifacts-builder."
---
...
- **Enhanced by**: **frontend-design**, **canvas-design**
- **Feeds into**: **web-artifacts-builder**
