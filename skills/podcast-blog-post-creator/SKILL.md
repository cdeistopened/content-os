---
name: podcast-blog-post-creator
version: 1.0.0
description: "When the user wants to transform a podcast episode into a compelling, SEO-optimized blog post. Also use when creating narrative-driven explainers from podcast transcripts. For full podcast production workflow, see podcast-production. For narrative extraction, see narrative-snippets."
---
...
- **Enhanced by**: **human-writing**, **article-titles**, **narrative-snippets**
- **Feeds into**: **social-content-creation**, **x-article-converter**, **how-newsletters**
