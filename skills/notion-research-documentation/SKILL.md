...
version: 1.0.0
description: "When the user wants to search across a Notion workspace and synthesize findings into structured research documentation. Also use when turning scattered Notion pages into reports with citations and actionable insights. For spec-to-task breakdowns, see notion-spec-to-implementation."
---
...
- **Upstream**: **notion-knowledge-capture**
- **Enhanced by**: **multi-source-research**, **semantic-chunking-rules**
- **Feeds into**: **notion-spec-to-implementation**
