...
version: 1.0.0
description: "When the user wants to generate AI images using Nano Banana Pro (Gemini API). Also use when creating thumbnails, social post images, blog headers, or creative visuals with iterative refinement. For the standard Gemini image generator, see image-prompt-generator."
---
...
- **editorial-concept.md** - Conceptual, bold colors, editorial wit
...
|--------------|-----------------|
| Newsletter | `images/newsletter/[date-folder]/` |
| Blog article | `images/blog/[article-folder]/` |
| Social media | `images/social/[campaign]/` |
...
- `editorial-concept.md` - Editorial concept style
...
For creating consistent, branded carousel content:

**Specs:**
- **Dimensions:** 1080x1350 (4:5 portrait) - use `--aspect 3:4`
- **Style:** Watercolor-line or your brand style
- **Typical structure:** Intro → Numbered steps → CTA

**Workflow:**

1. **Generate Slide 1 first** - This establishes the visual style
2. **Use Slide 1 as reference for subsequent slides** via rework mode
3. **Common edits:** Character appearance, CTA text, style consistency

**Naming convention:**
- `carousel-intro.png`
- `carousel-step1.png` through `carousel-stepN.png`
- `carousel-cta.png`
...
- **Upstream**: **image-prompt-generator**
- **Enhanced by**: **brand-guidelines**
