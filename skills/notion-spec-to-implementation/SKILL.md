...
version: 1.0.0
description: "When the user wants to turn product or tech specs into concrete Notion tasks for implementation. Also use when breaking down spec pages into detailed implementation plans with acceptance criteria and progress tracking. For research documentation, see notion-research-documentation."
---
...
- **Upstream**: **notion-research-documentation**
- **Enhanced by**: **notion-meeting-intelligence**
