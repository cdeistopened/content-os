...
version: 1.0.0
description: "When the user wants to generate AI videos with synchronized audio using Google's Veo 3.1 API. Also use when creating social clips, promotional teasers, ambient backgrounds, or creative visual storytelling. For AI image generation, see image-prompt-generator. For short-form video production, see short-form-video."
---
...
- **Enhanced by**: **short-form-video**, **video-caption-creation**
