...
version: 1.0.0
description: "When the user wants to transform raw podcast or interview transcripts into polished, readable documents while preserving authentic voice. Also use when cleaning up video captions or any spoken content. For semantic chunking of transcripts, see semantic-chunking-rules."
---
...
- **Feeds into**: **podcast-blog-post-creator**, **video-caption-creation**, **podcast-wiki-pipeline**
