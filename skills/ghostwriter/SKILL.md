...
name: ghostwriter
version: 1.0.0
description: "When the user wants to convert source material (transcripts, notes, research) into authentic, human-written prose with a distinctive voice. Also use when combining anti-AI writing with voice style adaptation. For core anti-AI patterns, see anti-ai-writing. For voice extraction, see voice-analyzer."
---
