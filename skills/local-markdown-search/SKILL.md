...
version: 1.0.0
description: "When the user wants to search across local markdown collections using QMD (Query Markup Documents). Also use when indexing transcripts, notes, documentation, or knowledge bases for full-text or semantic search. For wiki structure design, see wiki-ontology-design."
---
...
- **Feeds into**: **multi-source-research**, **podcast-wiki-pipeline**
