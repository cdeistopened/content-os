...
name: text-content
version: 1.0.0
description: "When the user wants to create text-only social media posts using 360+ proven templates across LinkedIn, X, Facebook, and Instagram. Also use when drafting platform-specific text posts with framework fitting. For multi-format social content, see social-content-creation. For one-liners, see dude-with-sign-writer."
---
...
- Does this sound like your brand, or like a template?
- Would your target reader feel seen?
