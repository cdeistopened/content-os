...
name: daily-notes
version: 1.0.0
description: "When the user wants to manage daily notes in M-D-YYYY format. Also use when viewing recent notes, creating today's note, summarizing the week, or referencing @notes/ or dates. For Apple Notes management, see memo."
---
