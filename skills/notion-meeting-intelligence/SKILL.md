...
version: 1.0.0
description: "When the user wants to prepare meeting materials by gathering Notion context and enriching with research. Also use when creating pre-read documents or external agendas for meetings. For capturing meeting outcomes, see notion-knowledge-capture."
---
...
- **Enhanced by**: **transcript-polisher**, **multi-source-research**
- **Feeds into**: **notion-knowledge-capture**
